...
const infiniteScroll = () => {
    const cardWidthWithMargin = firstCardWidth + 16; // Adjust this margin based on your design
    const totalWidth = cardWidthWithMargin * cardPerView;

    // If the carousel is at the beginning, scroll to the end
    if (carousel.scrollLeft <= 0) {
        carousel.classList.add("no-transition");
        carousel.scrollLeft = carousel.scrollWidth - (3 * totalWidth);
        carousel.classList.remove("no-transition");
    }
